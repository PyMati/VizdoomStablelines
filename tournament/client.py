...
parser.add_argument(
    "-n", "--playername", default="Mateusz Cieśliński", help="Name of a player."
)
...
game = vzd.DoomGame()
# game.load_config("tournament/scenarios/deathmatch.cfg")
game.load_config("defend_the_center.cfg")

# game.add_game_args("-join 127.0.0.1 -port 5029 " "+viz_connect_timeout 5 ")
